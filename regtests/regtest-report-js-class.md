...
var A =  function A()
{
	...
	this.__init__();
	var __callbound__;
			__callbound__ =  (function __call__()
	{
	...
	for (var _ in this) {__callbound__[_]=this[_];};
	__callbound__.__proto__ = this.__proto__;
	__callbound__.__call__ = __callbound__;
	return __callbound__;
}/*end->	`A`	*/
