...
/***/ if (main.__redef !== undefined) { return main.__redef.apply(this,arguments); };
	...
	console.log("--------");
	b = range(10).__getslice_lowerstep__(undefined, 2);
	console.log(b);
...
/***/ if (main.__redef !== undefined) { return main.__redef.apply(this,arguments); };
	var a,c,b,d;
	a = range(10);
	b = a.__getslice_lowerstep__(4, -1);
	...
	c = range(20);
	d = c.__getslice_lowerstep__(2, -1);
...
/***/ if (main.__redef !== undefined) { return main.__redef.apply(this,arguments); };
	...
	c = (a instanceof Array ? a.shift() : __jsdict_pop(a, 0));
