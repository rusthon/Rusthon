// PythonJS Runtime - regenerated on: Tue May 13 00:00:17 2014
...
_setup_str_prototype = function(args, kwargs) {
  ...
  String.prototype.__contains__ = func;
    ...
    if (( index ) < 0) {
      ...
      __right11 = index;
      return this[((((( typeof(__left10) ) == "number") ? (__left10 + __right11) : __add_op(__left10, __right11)).__uid__) ? ((( typeof(__left10) ) == "number") ? (__left10 + __right11) : __add_op(__left10, __right11)).__uid__ : ((( typeof(__left10) ) == "number") ? (__left10 + __right11) : __add_op(__left10, __right11)))];
    } else {
  ...
  String.prototype.__iter__ = func;
    ...
    if (( idx ) < 0) {
      ...
      __right13 = idx;
      return this[((((( typeof(__left12) ) == "number") ? (__left12 + __right13) : __add_op(__left12, __right13)).__uid__) ? ((( typeof(__left12) ) == "number") ? (__left12 + __right13) : __add_op(__left12, __right13)).__uid__ : ((( typeof(__left12) ) == "number") ? (__left12 + __right13) : __add_op(__left12, __right13)))];
    } else {
...
sum = function(args, kwargs) {
  ...
  var __sig__, __args__;
  __sig__ = { kwargs:Object(),args:__create_array__("arr") };
  __args__ = __getargs__("sum", __sig__, args, kwargs);
  var arr = __args__['arr'];
  a = 0;
  var b, __iterator__16;
  __iterator__16 = __get__(__get__(arr, "__iter__", "no iterator - line 738: for b in arr:"), "__call__")([], Object());
  var __next__16;
...
len = function(args, kwargs) {
  ...
  if (__test_if_true__(ob instanceof Array)) {
    ...
    if (__test_if_true__(ob instanceof Object)) {
      ...
      return __get__(__get__(ob, "__len__", "missing attribute `__len__` - line 754: return ob.__len__()"), "__call__")();
    }
  }
}
...
next = function(args, kwargs) {
  ...
  return __get__(__get__(obj, "next", "missing attribute `next` - line 758: return obj.next()"), "__call__")();
}
...
map = function(args, kwargs) {
  ...
  __iterator__17 = __get__(__get__(objs, "__iter__", "no iterator - line 763: for ob in objs:"), "__call__")([], Object());
  var __next__17;
...
filter = function(args, kwargs) {
  ...
  __iterator__18 = __get__(__get__(objs, "__iter__", "no iterator - line 771: for ob in objs:"), "__call__")([], Object());
  var __next__18;
...
min = function(args, kwargs) {
  ...
  __iterator__19 = __get__(__get__(lst, "__iter__", "no iterator - line 780: for value in lst:"), "__call__")([], Object());
  var __next__19;
...
max = function(args, kwargs) {
  ...
  __iterator__20 = __get__(__get__(lst, "__iter__", "no iterator - line 787: for value in lst:"), "__call__")([], Object());
  var __next__20;
...
__Iterator___init__ = function(args, kwargs) {
  ...
  self.obj_get = __get__(obj, "get", "missing attribute `get` - line 822: self.obj_get = obj.get  ## cache this for speed");
}
...
__pytuple___init__ = function(args, kwargs) {
  ...
  if (__test_if_true__(js_object instanceof Array)) {
    var item, __iterator__21;
    __iterator__21 = __get__(__get__(js_object, "__iter__", "no iterator - line 856: for item in js_object:"), "__call__")([], Object());
    var __next__21;
    __next__21 = __get__(__iterator__21, "next");
    while (( __iterator__21.index ) < __iterator__21.length) {
      item = __next__21();
      __get__(__get__(arr, "push", "missing attribute `push` - line 857: arr.push( item )"), "__call__")([item], __NULL_OBJECT__);
    }
  } else {
    if (__test_if_true__(js_object)) {
      if (__test_if_true__(isinstance([js_object, array], __NULL_OBJECT__) || isinstance([js_object, tuple], __NULL_OBJECT__) || isinstance([js_object, list], __NULL_OBJECT__))) {
        var v, __iterator__22;
        __iterator__22 = __get__(__get__(js_object, "__iter__", "no iterator - line 862: for v in js_object:"), "__call__")([], Object());
        var __next__22;
        __next__22 = __get__(__iterator__22, "next");
        while (( __iterator__22.index ) < __iterator__22.length) {
          v = __next__22();
          __get__(__get__(arr, "push", "missing attribute `push` - line 863: arr.push( v )"), "__call__")([v], __NULL_OBJECT__);
        }
      } else {
        throw new TypeError;
      }
...
__pytuple___getitem__ = function(args, kwargs) {
  ...
  if (( index ) < 0) {
    ...
    __left34 = __get__(self["$wrapped"], "length", "missing attribute `length` - line 871: index = self[...].length + index");
    __right35 = index;
    index = ((( typeof(__left34) ) == "number") ? (__left34 + __right35) : __add_op(__left34, __right35));
  }
...
__pylist___init__ = function(args, kwargs) {
  ...
  if (__test_if_true__(pointer)) {
    ...
    self["$wrapped"] = arr;
    if (__test_if_true__(js_object instanceof Array)) {
      var item, __iterator__24;
      __iterator__24 = __get__(__get__(js_object, "__iter__", "no iterator - line 938: for item in js_object:"), "__call__")([], Object());
      var __next__24;
      __next__24 = __get__(__iterator__24, "next");
      while (( __iterator__24.index ) < __iterator__24.length) {
        item = __next__24();
        __get__(__get__(arr, "push", "missing attribute `push` - line 939: arr.push( item )"), "__call__")([item], __NULL_OBJECT__);
      }
    } else {
      if (__test_if_true__(js_object)) {
        if (__test_if_true__(isinstance([js_object, array], __NULL_OBJECT__) || isinstance([js_object, tuple], __NULL_OBJECT__) || isinstance([js_object, list], __NULL_OBJECT__))) {
          var v, __iterator__25;
          __iterator__25 = __get__(__get__(js_object, "__iter__", "no iterator - line 944: for v in js_object:"), "__call__")([], Object());
          var __next__25;
          __next__25 = __get__(__iterator__25, "next");
          while (( __iterator__25.index ) < __iterator__25.length) {
            v = __next__25();
            __get__(__get__(arr, "push", "missing attribute `push` - line 945: arr.push( v )"), "__call__")([v], __NULL_OBJECT__);
          }
        } else {
          throw new TypeError;
        }
...
__pylist___getitem__ = function(args, kwargs) {
  ...
  if (( index ) < 0) {
    ...
    __left36 = __get__(self["$wrapped"], "length", "missing attribute `length` - line 952: index = self[...].length + index");
    __right37 = index;
    index = ((( typeof(__left36) ) == "number") ? (__left36 + __right37) : __add_op(__left36, __right37));
  }
  return self["$wrapped"][((index.__uid__) ? index.__uid__ : index)];
}
...
__pylist_extend = function(args, kwargs) {
  ...
  var obj, __iterator__26;
  __iterator__26 = __get__(__get__(other, "__iter__", "no iterator - line 970: for obj in other:"), "__call__")([], Object());
  var __next__26;
  __next__26 = __get__(__iterator__26, "next");
  while (( __iterator__26.index ) < __iterator__26.length) {
    obj = __next__26();
    __get__(__get__(self, "append", "missing attribute `append` - line 971: self.append(obj)"), "__call__")([obj], __NULL_OBJECT__);
  }
}
...
__pylist_remove = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var obj = __args__['obj'];
  index = __get__(__get__(self, "index", "missing attribute `index` - line 978: index = self.index(obj)"), "__call__")([obj], __NULL_OBJECT__);
...
__dict___init__ = function(args, kwargs) {
  ...
  if (( pointer ) !== null) {
    ...
    if (__test_if_true__(js_object)) {
      ob = js_object;
      if (__test_if_true__(ob instanceof Array)) {
        var o, __iterator__28;
        __iterator__28 = __get__(__get__(ob, "__iter__", "no iterator - line 1054: for o in ob:"), "__call__")([], Object());
        var __next__28;
        ...
        while (( __iterator__28.index ) < __iterator__28.length) {
          ...
          if (__test_if_true__(o instanceof Array)) {
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1056: self.__setitem__( o[0], o[1] )"), "__call__")([__get__(o, "__getitem__", "line 1056: self.__setitem__( o[0], o[1] )")([0], Object()), __get__(o, "__getitem__", "line 1056: self.__setitem__( o[0], o[1] )")([1], Object())], __NULL_OBJECT__);
          } else {
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1058: self.__setitem__( o['key'], o['value'] )"), "__call__")([__get__(o, "__getitem__", "line 1058: self.__setitem__( o['key'], o['value'] )")(["key"], Object()), __get__(o, "__getitem__", "line 1058: self.__setitem__( o['key'], o['value'] )")(["value"], Object())], __NULL_OBJECT__);
          }
        }
      } else {
        if (__test_if_true__(isinstance([ob, dict], __NULL_OBJECT__))) {
          var key, __iterator__29;
          __iterator__29 = __get__(__get__(__jsdict_keys(ob), "__iter__", "no iterator - line 1060: for key in ob.keys():"), "__call__")([], Object());
          var __next__29;
          __next__29 = __get__(__iterator__29, "next");
          while (( __iterator__29.index ) < __iterator__29.length) {
            key = __next__29();
            value = __get__(ob, "__getitem__", "line 1061: value = ob[ key ]")([key], Object());
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1062: self.__setitem__( key, value )"), "__call__")([key, value], __NULL_OBJECT__);
          }
        } else {
...
__dict_jsify = function(args, kwargs) {
  ...
  __iterator__30 = __get__(__get__(keys, "__iter__", "no iterator - line 1070: for key in keys:"), "__call__")([], Object());
  var __next__30;
  __next__30 = __get__(__iterator__30, "next");
  while (( __iterator__30.index ) < __iterator__30.length) {
    key = __next__30();
    value = __get__(self["$wrapped"], "__getitem__", "line 1071: value = self[...][key]")([key], Object());
    if (( typeof(value) ) == "object") {
      if (__test_if_true__(__get__(value, "jsify", "missing attribute `jsify` - line 1073: if value.jsify:"))) {
        __get__(__get__(self["$wrapped"], "__setitem__"), "__call__")([key, __get__(__get__(value, "jsify", "missing attribute `jsify` - line 1074: self[...][key] = value.jsify()"), "__call__")()], Object());
      }
    }
  }
  return self["$wrapped"];
...
__dict_has_key = function(args, kwargs) {
  ...
  if (__test_if_true__(typeof(key) === 'object' || typeof(key) === 'function')) {
    key = __get__(key, "__uid__", "missing attribute `__uid__` - line 1088: key = key.__uid__");
  }
...
__dict_update = function(args, kwargs) {
  ...
  __iterator__31 = __get__(__get__(other, "__iter__", "no iterator - line 1096: for key in other:"), "__call__")([], Object());
  var __next__31;
  __next__31 = __get__(__iterator__31, "next");
  while (( __iterator__31.index ) < __iterator__31.length) {
    key = __next__31();
    __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1097: self.__setitem__( key, other[key] )"), "__call__")([key, __get__(other, "__getitem__", "line 1097: self.__setitem__( key, other[key] )")([key], Object())], __NULL_OBJECT__);
  }
}
...
__dict_items = function(args, kwargs) {
  ...
  __iterator__32 = __get__(__get__(__jsdict_keys(self), "__iter__", "no iterator - line 1101: for key in self.keys():"), "__call__")([], Object());
  var __next__32;
  __next__32 = __get__(__iterator__32, "next");
  while (( __iterator__32.index ) < __iterator__32.length) {
    key = __next__32();
    __get__(__get__(arr, "append", "missing attribute `append` - line 1102: arr.append( [key, self[key]] )"), "__call__")([[key, __get__(self, "__getitem__")([key], Object())]], __NULL_OBJECT__);
  }
  return arr;
}
...
__dict_set = function(args, kwargs) {
  ...
  var key = __args__['key'];
  var value = __args__['value'];
  __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1112: self.__setitem__(key, value)"), "__call__")([key, value], __NULL_OBJECT__);
}
...
__array___init__ = function(args, kwargs) {
  ...
  self.itemsize = __get__(__get__(self, "typecodes", "missing attribute `typecodes` - line 1314: self.itemsize = self.typecodes[ typecode ]"), "__getitem__", "line 1314: self.itemsize = self.typecodes[ typecode ]")([typecode], Object());
  self.little_endian = little_endian;
  if (__test_if_true__(initializer)) {
    self.length = len([initializer], __NULL_OBJECT__);
    self.bytes = (__get__(self, "length", "missing attribute `length` - line 1319: self.bytes = self.length * self.itemsize") * __get__(self, "itemsize", "missing attribute `itemsize` - line 1319: self.bytes = self.length * self.itemsize"));
    if (( __get__(self, "typecode", "missing attribute `typecode` - line 1321: if self.typecode == 'float8':") ) == "float8") {
      self._scale = max([[abs([min([initializer], __NULL_OBJECT__)], __NULL_OBJECT__), max([initializer], __NULL_OBJECT__)]], __NULL_OBJECT__);
      self._norm_get = (__get__(self, "_scale", "missing attribute `_scale` - line 1323: self._norm_get = self._scale / 127  ## half 8bits-1") / 127);
      self._norm_set = (1.0 / __get__(self, "_norm_get", "missing attribute `_norm_get` - line 1324: self._norm_set = 1.0 / self._norm_get"));
    } else {
      if (( __get__(self, "typecode", "missing attribute `typecode` - line 1325: elif self.typecode == 'float16':") ) == "float16") {
        self._scale = max([[abs([min([initializer], __NULL_OBJECT__)], __NULL_OBJECT__), max([initializer], __NULL_OBJECT__)]], __NULL_OBJECT__);
        self._norm_get = (__get__(self, "_scale", "missing attribute `_scale` - line 1327: self._norm_get = self._scale / 32767  ## half 16bits-1") / 32767);
        self._norm_set = (1.0 / __get__(self, "_norm_get", "missing attribute `_norm_get` - line 1328: self._norm_set = 1.0 / self._norm_get"));
      }
    }
  } else {
    self.length = 0;
  ...
  size = __get__(self, "bytes", "missing attribute `bytes` - line 1334: size = self.bytes");
  buff = new ArrayBuffer(size);
  self.dataview = new DataView(buff);
  self.buffer = buff;
  __get__(__get__(self, "fromlist", "missing attribute `fromlist` - line 1338: self.fromlist( initializer )"), "__call__")([initializer], __NULL_OBJECT__);
}
...
__array___len__ = function(args, kwargs) {
  ...
  var self = __args__['self'];
  return __get__(self, "length", "missing attribute `length` - line 1341: return self.length");
}
...
__array___contains__ = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var value = __args__['value'];
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1346: arr = self.to_array()"), "__call__")();
...
__array___getitem__ = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var index = __args__['index'];
  step = __get__(self, "itemsize", "missing attribute `itemsize` - line 1352: step = self.itemsize");
  offset = (step * index);
  dataview = __get__(self, "dataview", "missing attribute `dataview` - line 1355: dataview = self.dataview");
  var __left38, __right39;
  __left38 = "get";
  __right39 = __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1356: func_name = 'get'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1356: func_name = 'get'+self.typecode_names[ self.typecode ]")([__get__(self, "typecode", "missing attribute `typecode` - line 1356: func_name = 'get'+self.typecode_names[ self.typecode ]")], Object());
  func_name = ((( typeof(__left38) ) == "number") ? (__left38 + __right39) : __add_op(__left38, __right39));
  func = dataview[func_name].bind(dataview);
  if (( offset ) < __get__(self, "bytes", "missing attribute `bytes` - line 1359: if offset < self.bytes:")) {
    value = func(offset);
    if (( __get__(self, "typecode", "missing attribute `typecode` - line 1361: if self.typecode == 'float8':") ) == "float8") {
      value = (value * __get__(self, "_norm_get", "missing attribute `_norm_get` - line 1362: value = value * self._norm_get"));
    } else {
      if (( __get__(self, "typecode", "missing attribute `typecode` - line 1363: elif self.typecode == 'float16':") ) == "float16") {
        value = (value * __get__(self, "_norm_get", "missing attribute `_norm_get` - line 1364: value = value * self._norm_get"));
      }
    }
    return value;
  } else {
...
__array___setitem__ = function(args, kwargs) {
  ...
  var index = __args__['index'];
  var value = __args__['value'];
  step = __get__(self, "itemsize", "missing attribute `itemsize` - line 1370: step = self.itemsize");
  if (( index ) < 0) {
    var __left40, __right41;
    __left40 = __get__(self, "length", "missing attribute `length` - line 1371: if index < 0: index = self.length + index -1  ## TODO fixme");
    __right41 = index;
    index = (((( typeof(__left40) ) == "number") ? (__left40 + __right41) : __add_op(__left40, __right41)) - 1);
  }
  offset = (step * index);
  dataview = __get__(self, "dataview", "missing attribute `dataview` - line 1374: dataview = self.dataview");
  var __left42, __right43;
  __left42 = "set";
  __right43 = __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1375: func_name = 'set'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1375: func_name = 'set'+self.typecode_names[ self.typecode ]")([__get__(self, "typecode", "missing attribute `typecode` - line 1375: func_name = 'set'+self.typecode_names[ self.typecode ]")], Object());
  func_name = ((( typeof(__left42) ) == "number") ? (__left42 + __right43) : __add_op(__left42, __right43));
  func = dataview[func_name].bind(dataview);
  if (( offset ) < __get__(self, "bytes", "missing attribute `bytes` - line 1378: if offset < self.bytes:")) {
    if (( __get__(self, "typecode", "missing attribute `typecode` - line 1379: if self.typecode == 'float8':") ) == "float8") {
      value = (value * __get__(self, "_norm_set", "missing attribute `_norm_set` - line 1380: value = value * self._norm_set"));
    } else {
      if (( __get__(self, "typecode", "missing attribute `typecode` - line 1381: elif self.typecode == 'float16':") ) == "float16") {
        value = (value * __get__(self, "_norm_set", "missing attribute `_norm_set` - line 1382: value = value * self._norm_set"));
      }
    }
    func(offset, value);
  } else {
...
__array_fromlist = function(args, kwargs) {
  ...
  step = __get__(self, "itemsize", "missing attribute `itemsize` - line 1396: step = self.itemsize");
  typecode = __get__(self, "typecode", "missing attribute `typecode` - line 1397: typecode = self.typecode");
  size = (length * step);
  dataview = __get__(self, "dataview", "missing attribute `dataview` - line 1399: dataview = self.dataview");
  var __left44, __right45;
  __left44 = "set";
  __right45 = __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1400: func_name = 'set'+self.typecode_names[ typecode ]"), "__getitem__", "line 1400: func_name = 'set'+self.typecode_names[ typecode ]")([typecode], Object());
  func_name = ((( typeof(__left44) ) == "number") ? (__left44 + __right45) : __add_op(__left44, __right45));
  func = dataview[func_name].bind(dataview);
  if (( size ) <= __get__(self, "bytes", "missing attribute `bytes` - line 1402: if size <= self.bytes:")) {
    i = 0;
    offset = 0;
    while (( i ) < length) {
      item = __get__(lst, "__getitem__", "line 1405: item = lst[i]")([i], Object());
      if (( typecode ) == "float8") {
        item *= __get__(self, "_norm_set", "missing attribute `_norm_set` - line 1407: item *= self._norm_set");
      } else {
        if (( typecode ) == "float16") {
          item *= __get__(self, "_norm_set", "missing attribute `_norm_set` - line 1409: item *= self._norm_set");
        }
      }
      func(offset,item);
      offset += step;
...
__array_resize = function(args, kwargs) {
  ...
  buff = __get__(self, "buffer", "missing attribute `buffer` - line 1418: buff = self.buffer");
  source = new Uint8Array(buff);
  new_size = (length * __get__(self, "itemsize", "missing attribute `itemsize` - line 1421: new_size = length * self.itemsize"));
...
__array_append = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var value = __args__['value'];
  length = __get__(self, "length", "missing attribute `length` - line 1432: length = self.length");
  var __left46, __right47;
  __left46 = __get__(self, "length", "missing attribute `length` - line 1433: self.resize( self.length + 1 )");
  __right47 = 1;
  __get__(__get__(self, "resize", "missing attribute `resize` - line 1433: self.resize( self.length + 1 )"), "__call__")([((( typeof(__left46) ) == "number") ? (__left46 + __right47) : __add_op(__left46, __right47))], __NULL_OBJECT__);
...
__array_extend = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var lst = __args__['lst'];
  var value, __iterator__37;
  __iterator__37 = __get__(__get__(lst, "__iter__", "no iterator - line 1437: for value in lst:"), "__call__")([], Object());
  var __next__37;
  __next__37 = __get__(__iterator__37, "next");
  while (( __iterator__37.index ) < __iterator__37.length) {
    value = __next__37();
    __get__(__get__(self, "append", "missing attribute `append` - line 1438: self.append( value )"), "__call__")([value], __NULL_OBJECT__);
  }
}
...
__array_to_array = function(args, kwargs) {
  ...
  arr = [];
  i = 0;
  while (( i ) < __get__(self, "length", "missing attribute `length` - line 1443: while i < self.length:")) {
...
__array_to_list = function(args, kwargs) {
  ...
  var self = __args__['self'];
  return __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1450: return self.to_array()"), "__call__")();
}
...
__array_to_ascii = function(args, kwargs) {
  ...
  var self = __args__['self'];
  string = "";
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1454: arr = self.to_array()"), "__call__")();
  i = 0;
  length = __get__(arr, "length", "missing attribute `length` - line 1455: i = 0; length = arr.length");
  while (( i ) < length) {
    var num = arr[i];
...
_to_pythonjs = function(args, kwargs) {
  ...
  if (__test_if_true__(Object.prototype.toString.call(json) === '[object Array]')) {
    ...
    ;
    append = __get__(output, "append", "missing attribute `append` - line 1484: append = output.append");
    var __iterator__38;
    __iterator__38 = __get__(__get__(raw, "__iter__", "no iterator - line 1485: for item in raw:"), "__call__")([], Object());
    var __next__38;
  ...
  ;
  set = __get__(output, "set", "missing attribute `set` - line 1491: set = output.set");
  var __args_2, __kwargs_2;
  __args_2 = [];
  __kwargs_2 = {"js_object": Object.keys(json)};
  keys = __get__(list, "__call__")(__args_2, __kwargs_2);
  var key, __iterator__39;
  __iterator__39 = __get__(__get__(keys, "__iter__", "no iterator - line 1493: for key in keys:"), "__call__")([], Object());
  var __next__39;
...
json_to_pythonjs = function(args, kwargs) {
  ...
  var json = __args__['json'];
  return _to_pythonjs([__get__(__get__(JSON, "parse", "missing attribute `parse` - line 1498: return _to_pythonjs(JSON.parse(json))"), "__call__")([json], __NULL_OBJECT__)], __NULL_OBJECT__);
}
...
_to_json = function(args, kwargs) {
  ...
  if (__test_if_true__(isinstance([pythonjs, list], __NULL_OBJECT__))) {
    r = [];
    var i, __iterator__40;
    __iterator__40 = __get__(__get__(pythonjs, "__iter__", "no iterator - line 1505: for i in pythonjs:"), "__call__")([], Object());
    var __next__40;
    __next__40 = __get__(__iterator__40, "next");
    while (( __iterator__40.index ) < __iterator__40.length) {
      i = __next__40();
      __get__(__get__(r, "push", "missing attribute `push` - line 1506: r.push(_to_json(i))"), "__call__")([_to_json([i], __NULL_OBJECT__)], __NULL_OBJECT__);
    }
  } else {
    if (__test_if_true__(isinstance([pythonjs, dict], __NULL_OBJECT__))) {
      ...
      r = Object();
      var __iterator__41;
      __iterator__41 = __get__(__get__(__jsdict_keys(pythonjs), "__iter__", "no iterator - line 1510: for key in pythonjs.keys():"), "__call__")([], Object());
      var __next__41;
...
pythonjs_to_json = function(args, kwargs) {
  ...
  var pythonjs = __args__['pythonjs'];
  return __get__(__get__(JSON, "stringify", "missing attribute `stringify` - line 1521: return JSON.stringify(_to_json(pythonjs))"), "__call__")([_to_json([pythonjs], __NULL_OBJECT__)], __NULL_OBJECT__);
}
