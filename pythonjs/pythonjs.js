...
__gpu_object = function(cls, struct_name) {
...
GLSLJITRuntime.prototype.__init__ = function(header) {
  ...
  this.glsltypes = ["vec2", "vec3", "vec4", "mat4", "mat4x4"];
  this.matrices = [];
}
...
GLSLJITRuntime.prototype.define_structure = function(ob) {
  ...
  structs = [];
  struct_type = [];
  if (__test_if_true__(struct_name && __contains__(this.glsltypes, struct_name) && Object.hasOwnProperty.call(ob, "elements"))) {
    return struct_name;
  }
    var __iter2 = dir(ob);
  if (! (__iter2 instanceof Array || typeof __iter2 == "string" || __is_typed_array(__iter2)) ) { __iter2 = __object_keys__(__iter2) }
...
GLSLJITRuntime.prototype.structure = function(ob, name) {
  ...
  if (! (__contains__(this.struct_types, sname))) {
    if (__contains__(this.glsltypes, sname)) {
      if (__test_if_true__(( sname ) == "mat4" || ( sname ) == "mat4x4")) {
        if (__test_if_true__(Object.hasOwnProperty.call(ob, "elements"))) {
          this.matrices.push(ob.elements);
          var i,i__end__;
          i = 0;
          i__end__ = ob.elements.length;
          while (( i ) < i__end__) {
            value = (ob.elements[i] + "");
...
issubclass = function(args, kwargs) {
  ...
  bases = C.__bases__;
  i = 0;
  while (( i ) < __get__(bases, "length", "missing attribute `length` - line 694: while i < bases.length:")) {
    if (__test_if_true__(issubclass([((bases instanceof Array) ? bases[i] : __get__(bases, "__getitem__", "line 695: if issubclass( bases[i], B ):")([i], __NULL_OBJECT__)), B], __NULL_OBJECT__))) {
      return true;
    }
    i += 1;
  }
...
sum = function(args, kwargs) {
  ...
  __iterator__39 = __get__(__get__(arr, "__iter__", "no iterator - line 1184: for b in arr:"), "__call__")([], __NULL_OBJECT__);
  var __next__39;
    ...
    if (__test_if_true__(__is_typed_array(ob))) {
      ...
      if (__test_if_true__(ob instanceof ArrayBuffer)) {
        ...
        if (__test_if_true__(ob instanceof Object)) {
          ...
          return __get__(__get__(ob, "__len__", "missing attribute `__len__` - line 1204: return ob.__len__()"), "__call__")();
        }
      }
    }
  }
...
next = function(args, kwargs) {
  ...
  return __get__(__get__(obj, "next", "missing attribute `next` - line 1208: return obj.next()"), "__call__")();
}
...
map = function(args, kwargs) {
  ...
  __iterator__40 = __get__(__get__(objs, "__iter__", "no iterator - line 1213: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__40;
...
filter = function(args, kwargs) {
  ...
  __iterator__41 = __get__(__get__(objs, "__iter__", "no iterator - line 1221: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__41;
...
min = function(args, kwargs) {
  ...
  __iterator__42 = __get__(__get__(lst, "__iter__", "no iterator - line 1230: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__42;
...
max = function(args, kwargs) {
  ...
  __iterator__43 = __get__(__get__(lst, "__iter__", "no iterator - line 1237: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__43;
...
__Iterator___init__ = function(args, kwargs) {
  ...
  self.obj_get = __get__(obj, "get", "missing attribute `get` - line 1272: self.obj_get = obj.get  ## cache this for speed");
}
  ...
  if (( pointer ) !== null) {
    ...
    if (__test_if_true__(js_object)) {
      ...
      if (__test_if_true__(ob instanceof Array)) {
        ...
        __iterator__44 = __get__(__get__(ob, "__iter__", "no iterator - line 1327: for o in ob:"), "__call__")([], __NULL_OBJECT__);
        var __next__44;
        ...
        if (__test_if_true__(isinstance([ob, dict], __NULL_OBJECT__))) {
          ...
          __iterator__45 = __get__(__get__(__jsdict_keys(ob), "__iter__", "no iterator - line 1333: for key in ob.keys():"), "__call__")([], __NULL_OBJECT__);
          var __next__45;
          __next__45 = __get__(__iterator__45, "next");
          while (( __iterator__45.index ) < __iterator__45.length) {
            key = __next__45();
            value = ((ob instanceof Array) ? ob[key] : __get__(ob, "__getitem__", "line 1334: value = ob[ key ]")([key], __NULL_OBJECT__));
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1335: self.__setitem__( key, value )"), "__call__")([key, value], __NULL_OBJECT__);
          }
        } else {
...
__dict_jsify = function(args, kwargs) {
  ...
  __iterator__46 = __get__(__get__(keys, "__iter__", "no iterator - line 1343: for key in keys:"), "__call__")([], __NULL_OBJECT__);
  var __next__46;
  __next__46 = __get__(__iterator__46, "next");
  while (( __iterator__46.index ) < __iterator__46.length) {
    key = __next__46();
    value = __get__(self["$wrapped"], "__getitem__", "line 1344: value = self[...][key]")([key], __NULL_OBJECT__);
    if (( typeof(value) ) == "object") {
      if (__test_if_true__(hasattr([value, "jsify"], __NULL_OBJECT__))) {
        __get__(__get__(self["$wrapped"], "__setitem__"), "__call__")([key, __get__(__get__(value, "jsify", "missing attribute `jsify` - line 1347: self[...][key] = value.jsify()"), "__call__")()], {});
      }
    } else {
...
__dict_has_key = function(args, kwargs) {
  ...
  if (__test_if_true__(typeof(key) === 'object' || typeof(key) === 'function')) {
    key = __get__(key, "__uid__", "missing attribute `__uid__` - line 1363: key = key.__uid__");
  }
...
__dict_update = function(args, kwargs) {
  ...
  __iterator__47 = __get__(__get__(other, "__iter__", "no iterator - line 1371: for key in other:"), "__call__")([], __NULL_OBJECT__);
  var __next__47;
  __next__47 = __get__(__iterator__47, "next");
  while (( __iterator__47.index ) < __iterator__47.length) {
    key = __next__47();
    __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1372: self.__setitem__( key, other[key] )"), "__call__")([key, ((other instanceof Array) ? other[key] : __get__(other, "__getitem__", "line 1372: self.__setitem__( key, other[key] )")([key], __NULL_OBJECT__))], __NULL_OBJECT__);
  }
}
...
__dict_items = function(args, kwargs) {
  ...
  __iterator__48 = __get__(__get__(__jsdict_keys(self), "__iter__", "no iterator - line 1376: for key in self.keys():"), "__call__")([], __NULL_OBJECT__);
  var __next__48;
  __next__48 = __get__(__iterator__48, "next");
  while (( __iterator__48.index ) < __iterator__48.length) {
    key = __next__48();
    __get__(__get__(arr, "append", "missing attribute `append` - line 1377: arr.append( [key, self[key]] )"), "__call__")([[key, __get__(self, "__getitem__")([key], __NULL_OBJECT__)]], __NULL_OBJECT__);
  }
  return arr;
}
...
__dict_set = function(args, kwargs) {
  ...
  var key = __args__['key'];
  var value = __args__['value'];
  __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1387: self.__setitem__(key, value)"), "__call__")([key, value], __NULL_OBJECT__);
}
...
__array___init__ = function(args, kwargs) {
  ...
  self.itemsize = __get__(__get__(self, "typecodes", "missing attribute `typecodes` - line 1588: self.itemsize = self.typecodes[ typecode ]"), "__getitem__", "line 1588: self.itemsize = self.typecodes[ typecode ]")([typecode], __NULL_OBJECT__);
  ...
  self.buffer = buff;
  __get__(__get__(self, "fromlist", "missing attribute `fromlist` - line 1612: self.fromlist( initializer )"), "__call__")([initializer], __NULL_OBJECT__);
}
...
__array___contains__ = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var value = __args__['value'];
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1620: arr = self.to_array()"), "__call__")();
...
__array___getitem__ = function(args, kwargs) {
  ...
  func_name = ("get" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1630: func_name = 'get'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1630: func_name = 'get'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__));
...
__array___setitem__ = function(args, kwargs) {
  ...
  offset = (step * index);
  dataview = self.dataview;
  func_name = ("set" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1649: func_name = 'set'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1649: func_name = 'set'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__));
  func = dataview[func_name].bind(dataview);
  if (( offset ) < self.bytes) {
    if (( self.typecode ) == "float8") {
...
__array_fromlist = function(args, kwargs) {
  ...
  size = (length * step);
  dataview = self.dataview;
  func_name = ("set" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1674: func_name = 'set'+self.typecode_names[ typecode ]"), "__getitem__", "line 1674: func_name = 'set'+self.typecode_names[ typecode ]")([typecode], __NULL_OBJECT__));
  func = dataview[func_name].bind(dataview);
  if (( size ) <= self.bytes) {
    i = 0;
    offset = 0;
    while (( i ) < length) {
      item = ((lst instanceof Array) ? lst[i] : __get__(lst, "__getitem__", "line 1679: item = lst[i]")([i], __NULL_OBJECT__));
      if (( typecode ) == "float8") {
        item *= self._norm_set;
      } else {
        if (( typecode ) == "float16") {
...
__array_append = function(args, kwargs) {
  ...
  var value = __args__['value'];
  length = self.length;
  __get__(__get__(self, "resize", "missing attribute `resize` - line 1707: self.resize( self.length + 1 )"), "__call__")([(self.length + 1)], __NULL_OBJECT__);
...
__array_extend = function(args, kwargs) {
  ...
  __iterator__53 = __get__(__get__(lst, "__iter__", "no iterator - line 1711: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__53;
  __next__53 = __get__(__iterator__53, "next");
  while (( __iterator__53.index ) < __iterator__53.length) {
    value = __next__53();
    __get__(__get__(self, "append", "missing attribute `append` - line 1712: self.append( value )"), "__call__")([value], __NULL_OBJECT__);
  }
}
...
__array_to_list = function(args, kwargs) {
  ...
  var self = __args__['self'];
  return __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1724: return self.to_array()"), "__call__")();
}
...
__array_to_ascii = function(args, kwargs) {
  ...
  var self = __args__['self'];
  string = "";
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1728: arr = self.to_array()"), "__call__")();
  i = 0;
  length = __get__(arr, "length", "missing attribute `length` - line 1729: i = 0; length = arr.length");
  while (( i ) < length) {
    var num = arr[i];
...
__start_new_thread = function(f, args) {
  ...
  i = 0;
    var __iter41 = args;
  if (! (__iter41 instanceof Array || typeof __iter41 == "string" || __is_typed_array(__iter41)) ) { __iter41 = __object_keys__(__iter41) }
