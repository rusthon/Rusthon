...
__glsl_inline_object = function(ob) {
...
issubclass = function(args, kwargs) {
  ...
  bases = C.__bases__;
  i = 0;
  while (( i ) < __get__(bases, "length", "missing attribute `length` - line 449: while i < bases.length:")) {
    if (__test_if_true__(issubclass([((bases instanceof Array) ? bases[i] : __get__(bases, "__getitem__", "line 450: if issubclass( bases[i], B ):")([i], __NULL_OBJECT__)), B], __NULL_OBJECT__))) {
      return true;
    }
    i += 1;
  }
...
sum = function(args, kwargs) {
  ...
  __iterator__24 = __get__(__get__(arr, "__iter__", "no iterator - line 925: for b in arr:"), "__call__")([], __NULL_OBJECT__);
  var __next__24;
    ...
    if (__test_if_true__(__is_typed_array(ob))) {
      ...
      if (__test_if_true__(ob instanceof ArrayBuffer)) {
        ...
        if (__test_if_true__(ob instanceof Object)) {
          ...
          return __get__(__get__(ob, "__len__", "missing attribute `__len__` - line 945: return ob.__len__()"), "__call__")();
        }
      }
    }
  }
...
next = function(args, kwargs) {
  ...
  return __get__(__get__(obj, "next", "missing attribute `next` - line 949: return obj.next()"), "__call__")();
}
...
map = function(args, kwargs) {
  ...
  __iterator__25 = __get__(__get__(objs, "__iter__", "no iterator - line 954: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__25;
...
filter = function(args, kwargs) {
  ...
  __iterator__26 = __get__(__get__(objs, "__iter__", "no iterator - line 962: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__26;
...
min = function(args, kwargs) {
  ...
  __iterator__27 = __get__(__get__(lst, "__iter__", "no iterator - line 971: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__27;
...
max = function(args, kwargs) {
  ...
  __iterator__28 = __get__(__get__(lst, "__iter__", "no iterator - line 978: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__28;
...
__Iterator___init__ = function(args, kwargs) {
  ...
  self.obj_get = __get__(obj, "get", "missing attribute `get` - line 1013: self.obj_get = obj.get  ## cache this for speed");
}
  ...
  if (( pointer ) !== null) {
    ...
    if (__test_if_true__(js_object)) {
      ...
      if (__test_if_true__(ob instanceof Array)) {
        ...
        __iterator__29 = __get__(__get__(ob, "__iter__", "no iterator - line 1068: for o in ob:"), "__call__")([], __NULL_OBJECT__);
        var __next__29;
        ...
        if (__test_if_true__(isinstance([ob, dict], __NULL_OBJECT__))) {
          ...
          __iterator__30 = __get__(__get__(__jsdict_keys(ob), "__iter__", "no iterator - line 1074: for key in ob.keys():"), "__call__")([], __NULL_OBJECT__);
          var __next__30;
          __next__30 = __get__(__iterator__30, "next");
          while (( __iterator__30.index ) < __iterator__30.length) {
            key = __next__30();
            value = ((ob instanceof Array) ? ob[key] : __get__(ob, "__getitem__", "line 1075: value = ob[ key ]")([key], __NULL_OBJECT__));
...
__dict_jsify = function(args, kwargs) {
  ...
  __iterator__31 = __get__(__get__(keys, "__iter__", "no iterator - line 1084: for key in keys:"), "__call__")([], __NULL_OBJECT__);
  var __next__31;
  __next__31 = __get__(__iterator__31, "next");
  while (( __iterator__31.index ) < __iterator__31.length) {
    key = __next__31();
    value = __get__(self["$wrapped"], "__getitem__", "line 1085: value = self[...][key]")([key], __NULL_OBJECT__);
    if (( typeof(value) ) == "object") {
      if (__test_if_true__(hasattr([value, "jsify"], __NULL_OBJECT__))) {
        __get__(__get__(self["$wrapped"], "__setitem__"), "__call__")([key, __get__(__get__(value, "jsify", "missing attribute `jsify` - line 1088: self[...][key] = value.jsify()"), "__call__")()], {});
      }
    } else {
...
__dict_has_key = function(args, kwargs) {
  ...
  if (__test_if_true__(typeof(key) === 'object' || typeof(key) === 'function')) {
    key = __get__(key, "__uid__", "missing attribute `__uid__` - line 1104: key = key.__uid__");
  }
...
__dict_update = function(args, kwargs) {
  ...
  __iterator__32 = __get__(__get__(other, "__iter__", "no iterator - line 1112: for key in other:"), "__call__")([], __NULL_OBJECT__);
  var __next__32;
  __next__32 = __get__(__iterator__32, "next");
  while (( __iterator__32.index ) < __iterator__32.length) {
    key = __next__32();
    __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1113: self.__setitem__( key, other[key] )"), "__call__")([key, ((other instanceof Array) ? other[key] : __get__(other, "__getitem__", "line 1113: self.__setitem__( key, other[key] )")([key], __NULL_OBJECT__))], __NULL_OBJECT__);
  }
}
...
__dict_items = function(args, kwargs) {
  ...
  __iterator__33 = __get__(__get__(__jsdict_keys(self), "__iter__", "no iterator - line 1117: for key in self.keys():"), "__call__")([], __NULL_OBJECT__);
  var __next__33;
  __next__33 = __get__(__iterator__33, "next");
  while (( __iterator__33.index ) < __iterator__33.length) {
    key = __next__33();
    __get__(__get__(arr, "append", "missing attribute `append` - line 1118: arr.append( [key, self[key]] )"), "__call__")([[key, __get__(self, "__getitem__")([key], __NULL_OBJECT__)]], __NULL_OBJECT__);
  }
  return arr;
}
...
__dict_set = function(args, kwargs) {
  ...
  var key = __args__['key'];
  var value = __args__['value'];
  __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1128: self.__setitem__(key, value)"), "__call__")([key, value], __NULL_OBJECT__);
}
...
__array___init__ = function(args, kwargs) {
  ...
  self.itemsize = __get__(__get__(self, "typecodes", "missing attribute `typecodes` - line 1329: self.itemsize = self.typecodes[ typecode ]"), "__getitem__", "line 1329: self.itemsize = self.typecodes[ typecode ]")([typecode], __NULL_OBJECT__);
  ...
  self.buffer = buff;
  __get__(__get__(self, "fromlist", "missing attribute `fromlist` - line 1353: self.fromlist( initializer )"), "__call__")([initializer], __NULL_OBJECT__);
}
...
__array___contains__ = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var value = __args__['value'];
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1361: arr = self.to_array()"), "__call__")();
...
__array___getitem__ = function(args, kwargs) {
  ...
  func_name = ("get" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1371: func_name = 'get'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1371: func_name = 'get'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__));
...
__array___setitem__ = function(args, kwargs) {
  ...
  offset = (step * index);
  dataview = self.dataview;
  func_name = ("set" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1390: func_name = 'set'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1390: func_name = 'set'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__));
  func = dataview[func_name].bind(dataview);
  if (( offset ) < self.bytes) {
    if (( self.typecode ) == "float8") {
...
__array_append = function(args, kwargs) {
  ...
  var value = __args__['value'];
  length = self.length;
  __get__(__get__(self, "resize", "missing attribute `resize` - line 1448: self.resize( self.length + 1 )"), "__call__")([(self.length + 1)], __NULL_OBJECT__);
...
__array_extend = function(args, kwargs) {
  ...
  __iterator__38 = __get__(__get__(lst, "__iter__", "no iterator - line 1452: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__38;
  __next__38 = __get__(__iterator__38, "next");
  while (( __iterator__38.index ) < __iterator__38.length) {
    value = __next__38();
    __get__(__get__(self, "append", "missing attribute `append` - line 1453: self.append( value )"), "__call__")([value], __NULL_OBJECT__);
  }
}
...
__array_to_list = function(args, kwargs) {
  ...
  var self = __args__['self'];
  return __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1465: return self.to_array()"), "__call__")();
}
...
__array_to_ascii = function(args, kwargs) {
  ...
  var self = __args__['self'];
  string = "";
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1469: arr = self.to_array()"), "__call__")();
  i = 0;
  length = __get__(arr, "length", "missing attribute `length` - line 1470: i = 0; length = arr.length");
  while (( i ) < length) {
    var num = arr[i];
