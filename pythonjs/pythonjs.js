// PythonJS Runtime - regenerated on: Mon May 19 17:06:34 2014
...
issubclass = function(args, kwargs) {
  ...
  bases = C.__bases__;
  i = 0;
  while (( i ) < __get__(bases, "length", "missing attribute `length` - line 355: while i < bases.length:")) {
    if (__test_if_true__(issubclass([__get__(bases, "__getitem__", "line 356: if issubclass( bases[i], B ):")([i], __NULL_OBJECT__), B], __NULL_OBJECT__))) {
      return true;
    }
    i += 1;
  }
...
bisect = function(args, kwargs) {
  ...
  return __get__(__get__(a, "bisect", "missing attribute `bisect` - line 717: return a.bisect(x, low, high)"), "__call__")([x, low, high], __NULL_OBJECT__);
}
...
sum = function(args, kwargs) {
  ...
  __iterator__16 = __get__(__get__(arr, "__iter__", "no iterator - line 741: for b in arr:"), "__call__")([], __NULL_OBJECT__);
  var __next__16;
...
len = function(args, kwargs) {
  ...
  if (__test_if_true__(ob instanceof Array)) {
    ...
    if (__test_if_true__(ob instanceof Object)) {
      ...
      return __get__(__get__(ob, "__len__", "missing attribute `__len__` - line 757: return ob.__len__()"), "__call__")();
    }
  }
}
...
next = function(args, kwargs) {
  ...
  return __get__(__get__(obj, "next", "missing attribute `next` - line 761: return obj.next()"), "__call__")();
}
...
map = function(args, kwargs) {
  ...
  __iterator__17 = __get__(__get__(objs, "__iter__", "no iterator - line 766: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__17;
...
filter = function(args, kwargs) {
  ...
  __iterator__18 = __get__(__get__(objs, "__iter__", "no iterator - line 774: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__18;
...
min = function(args, kwargs) {
  ...
  __iterator__19 = __get__(__get__(lst, "__iter__", "no iterator - line 783: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__19;
...
max = function(args, kwargs) {
  ...
  __iterator__20 = __get__(__get__(lst, "__iter__", "no iterator - line 790: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__20;
...
__Iterator___init__ = function(args, kwargs) {
  ...
  self.obj_get = __get__(obj, "get", "missing attribute `get` - line 825: self.obj_get = obj.get  ## cache this for speed");
}
...
__pytuple___init__ = function(args, kwargs) {
  ...
  if (__test_if_true__(js_object instanceof Array)) {
    ...
    __iterator__21 = __get__(__get__(js_object, "__iter__", "no iterator - line 859: for item in js_object:"), "__call__")([], __NULL_OBJECT__);
    var __next__21;
    __next__21 = __get__(__iterator__21, "next");
    while (( __iterator__21.index ) < __iterator__21.length) {
      item = __next__21();
      __get__(__get__(arr, "push", "missing attribute `push` - line 860: arr.push( item )"), "__call__")([item], __NULL_OBJECT__);
    }
  } else {
    if (__test_if_true__(js_object)) {
      if (__test_if_true__(isinstance([js_object, array], __NULL_OBJECT__) || isinstance([js_object, tuple], __NULL_OBJECT__) || isinstance([js_object, list], __NULL_OBJECT__))) {
        ...
        __iterator__22 = __get__(__get__(js_object, "__iter__", "no iterator - line 865: for v in js_object:"), "__call__")([], __NULL_OBJECT__);
        var __next__22;
        __next__22 = __get__(__iterator__22, "next");
        while (( __iterator__22.index ) < __iterator__22.length) {
          v = __next__22();
          __get__(__get__(arr, "push", "missing attribute `push` - line 866: arr.push( v )"), "__call__")([v], __NULL_OBJECT__);
        }
      } else {
        throw new TypeError;
      }
...
__pytuple___getitem__ = function(args, kwargs) {
  ...
  if (( index ) < 0) {
    ...
    __left34 = __get__(self["$wrapped"], "length", "missing attribute `length` - line 874: index = self[...].length + index");
    __right35 = index;
...
__pylist___init__ = function(args, kwargs) {
  ...
  if (__test_if_true__(pointer)) {
    ...
    if (__test_if_true__(js_object instanceof Array)) {
      ...
      __iterator__24 = __get__(__get__(js_object, "__iter__", "no iterator - line 941: for item in js_object:"), "__call__")([], __NULL_OBJECT__);
      var __next__24;
      __next__24 = __get__(__iterator__24, "next");
      while (( __iterator__24.index ) < __iterator__24.length) {
        item = __next__24();
        __get__(__get__(arr, "push", "missing attribute `push` - line 942: arr.push( item )"), "__call__")([item], __NULL_OBJECT__);
      }
    } else {
      if (__test_if_true__(js_object)) {
        if (__test_if_true__(isinstance([js_object, array], __NULL_OBJECT__) || isinstance([js_object, tuple], __NULL_OBJECT__) || isinstance([js_object, list], __NULL_OBJECT__))) {
          var v, __iterator__25;
          __iterator__25 = __get__(__get__(js_object, "__iter__", "no iterator - line 947: for v in js_object:"), "__call__")([], __NULL_OBJECT__);
          var __next__25;
          __next__25 = __get__(__iterator__25, "next");
          while (( __iterator__25.index ) < __iterator__25.length) {
            v = __next__25();
            __get__(__get__(arr, "push", "missing attribute `push` - line 948: arr.push( v )"), "__call__")([v], __NULL_OBJECT__);
          }
        } else {
          throw new TypeError;
        }
...
__pylist___getitem__ = function(args, kwargs) {
  ...
  if (( index ) < 0) {
    ...
    __left36 = __get__(self["$wrapped"], "length", "missing attribute `length` - line 955: index = self[...].length + index");
    __right37 = index;
...
__pylist_extend = function(args, kwargs) {
  ...
  __iterator__26 = __get__(__get__(other, "__iter__", "no iterator - line 973: for obj in other:"), "__call__")([], __NULL_OBJECT__);
  var __next__26;
  __next__26 = __get__(__iterator__26, "next");
  while (( __iterator__26.index ) < __iterator__26.length) {
    obj = __next__26();
    __get__(__get__(self, "append", "missing attribute `append` - line 974: self.append(obj)"), "__call__")([obj], __NULL_OBJECT__);
  }
}
...
__pylist_remove = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var obj = __args__['obj'];
  index = __get__(__get__(self, "index", "missing attribute `index` - line 981: index = self.index(obj)"), "__call__")([obj], __NULL_OBJECT__);
  ...
  if (( pointer ) !== null) {
    ...
    if (__test_if_true__(js_object)) {
      ...
      if (__test_if_true__(ob instanceof Array)) {
        ...
        __iterator__28 = __get__(__get__(ob, "__iter__", "no iterator - line 1057: for o in ob:"), "__call__")([], __NULL_OBJECT__);
        var __next__28;
        ...
        while (( __iterator__28.index ) < __iterator__28.length) {
          ...
          if (__test_if_true__(o instanceof Array)) {
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1059: self.__setitem__( o[0], o[1] )"), "__call__")([__get__(o, "__getitem__", "line 1059: self.__setitem__( o[0], o[1] )")([0], __NULL_OBJECT__), __get__(o, "__getitem__", "line 1059: self.__setitem__( o[0], o[1] )")([1], __NULL_OBJECT__)], __NULL_OBJECT__);
          } else {
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1061: self.__setitem__( o['key'], o['value'] )"), "__call__")([__get__(o, "__getitem__", "line 1061: self.__setitem__( o['key'], o['value'] )")(["key"], __NULL_OBJECT__), __get__(o, "__getitem__", "line 1061: self.__setitem__( o['key'], o['value'] )")(["value"], __NULL_OBJECT__)], __NULL_OBJECT__);
          }
        }
      } else {
        if (__test_if_true__(isinstance([ob, dict], __NULL_OBJECT__))) {
          var key, __iterator__29;
          __iterator__29 = __get__(__get__(__jsdict_keys(ob), "__iter__", "no iterator - line 1063: for key in ob.keys():"), "__call__")([], __NULL_OBJECT__);
          var __next__29;
          __next__29 = __get__(__iterator__29, "next");
          while (( __iterator__29.index ) < __iterator__29.length) {
            key = __next__29();
            value = __get__(ob, "__getitem__", "line 1064: value = ob[ key ]")([key], __NULL_OBJECT__);
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1065: self.__setitem__( key, value )"), "__call__")([key, value], __NULL_OBJECT__);
          }
        } else {
...
__dict_jsify = function(args, kwargs) {
  ...
  __iterator__30 = __get__(__get__(keys, "__iter__", "no iterator - line 1073: for key in keys:"), "__call__")([], __NULL_OBJECT__);
  var __next__30;
  __next__30 = __get__(__iterator__30, "next");
  while (( __iterator__30.index ) < __iterator__30.length) {
    key = __next__30();
    value = __get__(self["$wrapped"], "__getitem__", "line 1074: value = self[...][key]")([key], __NULL_OBJECT__);
    if (( typeof(value) ) == "object") {
      if (__test_if_true__(__get__(value, "jsify", "missing attribute `jsify` - line 1076: if value.jsify:"))) {
        __get__(__get__(self["$wrapped"], "__setitem__"), "__call__")([key, __get__(__get__(value, "jsify", "missing attribute `jsify` - line 1077: self[...][key] = value.jsify()"), "__call__")()], {});
      }
    }
  }
  return self["$wrapped"];
...
__dict_has_key = function(args, kwargs) {
  ...
  if (__test_if_true__(typeof(key) === 'object' || typeof(key) === 'function')) {
    key = __get__(key, "__uid__", "missing attribute `__uid__` - line 1091: key = key.__uid__");
  }
...
__dict_update = function(args, kwargs) {
  ...
  __iterator__31 = __get__(__get__(other, "__iter__", "no iterator - line 1099: for key in other:"), "__call__")([], __NULL_OBJECT__);
  var __next__31;
  __next__31 = __get__(__iterator__31, "next");
  while (( __iterator__31.index ) < __iterator__31.length) {
    key = __next__31();
    __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1100: self.__setitem__( key, other[key] )"), "__call__")([key, __get__(other, "__getitem__", "line 1100: self.__setitem__( key, other[key] )")([key], __NULL_OBJECT__)], __NULL_OBJECT__);
  }
}
...
__dict_items = function(args, kwargs) {
  ...
  __iterator__32 = __get__(__get__(__jsdict_keys(self), "__iter__", "no iterator - line 1104: for key in self.keys():"), "__call__")([], __NULL_OBJECT__);
  var __next__32;
  __next__32 = __get__(__iterator__32, "next");
  while (( __iterator__32.index ) < __iterator__32.length) {
    key = __next__32();
    __get__(__get__(arr, "append", "missing attribute `append` - line 1105: arr.append( [key, self[key]] )"), "__call__")([[key, __get__(self, "__getitem__")([key], __NULL_OBJECT__)]], __NULL_OBJECT__);
  }
  return arr;
}
...
__dict_set = function(args, kwargs) {
  ...
  var key = __args__['key'];
  var value = __args__['value'];
  __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1115: self.__setitem__(key, value)"), "__call__")([key, value], __NULL_OBJECT__);
}
...
__array___init__ = function(args, kwargs) {
  ...
  self.itemsize = __get__(__get__(self, "typecodes", "missing attribute `typecodes` - line 1317: self.itemsize = self.typecodes[ typecode ]"), "__getitem__", "line 1317: self.itemsize = self.typecodes[ typecode ]")([typecode], __NULL_OBJECT__);
  ...
  self.buffer = buff;
  __get__(__get__(self, "fromlist", "missing attribute `fromlist` - line 1341: self.fromlist( initializer )"), "__call__")([initializer], __NULL_OBJECT__);
}
...
__array___contains__ = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var value = __args__['value'];
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1349: arr = self.to_array()"), "__call__")();
...
__array___getitem__ = function(args, kwargs) {
  ...
  __left38 = "get";
  __right39 = __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1359: func_name = 'get'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1359: func_name = 'get'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__);
...
__array___setitem__ = function(args, kwargs) {
  ...
  __left42 = "set";
  __right43 = __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1378: func_name = 'set'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1378: func_name = 'set'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__);
...
__array_fromlist = function(args, kwargs) {
  ...
  __left44 = "set";
  __right45 = __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1403: func_name = 'set'+self.typecode_names[ typecode ]"), "__getitem__", "line 1403: func_name = 'set'+self.typecode_names[ typecode ]")([typecode], __NULL_OBJECT__);
  ...
  if (( size ) <= self.bytes) {
    ...
    offset = 0;
    while (( i ) < length) {
      item = __get__(lst, "__getitem__", "line 1408: item = lst[i]")([i], __NULL_OBJECT__);
      if (( typecode ) == "float8") {
        item *= self._norm_set;
      } else {
        if (( typecode ) == "float16") {
...
__array_append = function(args, kwargs) {
  ...
  __right47 = 1;
  __get__(__get__(self, "resize", "missing attribute `resize` - line 1436: self.resize( self.length + 1 )"), "__call__")([((( typeof(__left46) ) == "number") ? (__left46 + __right47) : __add_op(__left46, __right47))], __NULL_OBJECT__);
...
__array_extend = function(args, kwargs) {
  ...
  __iterator__37 = __get__(__get__(lst, "__iter__", "no iterator - line 1440: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__37;
  __next__37 = __get__(__iterator__37, "next");
  while (( __iterator__37.index ) < __iterator__37.length) {
    value = __next__37();
    __get__(__get__(self, "append", "missing attribute `append` - line 1441: self.append( value )"), "__call__")([value], __NULL_OBJECT__);
  }
}
...
__array_to_ascii = function(args, kwargs) {
  ...
  var self = __args__['self'];
  string = "";
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1457: arr = self.to_array()"), "__call__")();
  i = 0;
  length = __get__(arr, "length", "missing attribute `length` - line 1458: i = 0; length = arr.length");
  while (( i ) < length) {
    var num = arr[i];
...
_to_pythonjs = function(args, kwargs) {
  ...
  if (__test_if_true__(Object.prototype.toString.call(json) === '[object Array]')) {
    ...
    ;
    append = __get__(output, "append", "missing attribute `append` - line 1487: append = output.append");
    var __iterator__38;
    __iterator__38 = __get__(__get__(raw, "__iter__", "no iterator - line 1488: for item in raw:"), "__call__")([], __NULL_OBJECT__);
    var __next__38;
  ...
  ;
  set = __get__(output, "set", "missing attribute `set` - line 1494: set = output.set");
  ...
  __iterator__39 = __get__(__get__(keys, "__iter__", "no iterator - line 1496: for key in keys:"), "__call__")([], __NULL_OBJECT__);
  var __next__39;
...
json_to_pythonjs = function(args, kwargs) {
  ...
  var json = __args__['json'];
  return _to_pythonjs([__get__(__get__(JSON, "parse", "missing attribute `parse` - line 1501: return _to_pythonjs(JSON.parse(json))"), "__call__")([json], __NULL_OBJECT__)], __NULL_OBJECT__);
}
...
_to_json = function(args, kwargs) {
  ...
  if (__test_if_true__(isinstance([pythonjs, list], __NULL_OBJECT__))) {
    ...
    __iterator__40 = __get__(__get__(pythonjs, "__iter__", "no iterator - line 1508: for i in pythonjs:"), "__call__")([], __NULL_OBJECT__);
    var __next__40;
    __next__40 = __get__(__iterator__40, "next");
    while (( __iterator__40.index ) < __iterator__40.length) {
      i = __next__40();
      __get__(__get__(r, "push", "missing attribute `push` - line 1509: r.push(_to_json(i))"), "__call__")([_to_json([i], __NULL_OBJECT__)], __NULL_OBJECT__);
    }
  } else {
    if (__test_if_true__(isinstance([pythonjs, dict], __NULL_OBJECT__))) {
      ...
      r = {};
      var __iterator__41;
      __iterator__41 = __get__(__get__(__jsdict_keys(pythonjs), "__iter__", "no iterator - line 1513: for key in pythonjs.keys():"), "__call__")([], __NULL_OBJECT__);
      var __next__41;
...
pythonjs_to_json = function(args, kwargs) {
  ...
  var pythonjs = __args__['pythonjs'];
  return __get__(__get__(JSON, "stringify", "missing attribute `stringify` - line 1524: return JSON.stringify(_to_json(pythonjs))"), "__call__")([_to_json([pythonjs], __NULL_OBJECT__)], __NULL_OBJECT__);
}
