...
sum = function(args, kwargs) {
  ...
  __iterator__19 = __get__(__get__(arr, "__iter__", "no iterator - line 784: for b in arr:"), "__call__")([], __NULL_OBJECT__);
  var __next__19;
    ...
    if (__test_if_true__(__is_typed_array(ob))) {
      ...
      if (__test_if_true__(ob instanceof ArrayBuffer)) {
        ...
        if (__test_if_true__(ob instanceof Object)) {
          ...
          return __get__(__get__(ob, "__len__", "missing attribute `__len__` - line 804: return ob.__len__()"), "__call__")();
        }
      }
    }
  }
...
next = function(args, kwargs) {
  ...
  return __get__(__get__(obj, "next", "missing attribute `next` - line 808: return obj.next()"), "__call__")();
}
...
map = function(args, kwargs) {
  ...
  __iterator__20 = __get__(__get__(objs, "__iter__", "no iterator - line 813: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__20;
...
filter = function(args, kwargs) {
  ...
  __iterator__21 = __get__(__get__(objs, "__iter__", "no iterator - line 821: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__21;
...
min = function(args, kwargs) {
  ...
  __iterator__22 = __get__(__get__(lst, "__iter__", "no iterator - line 830: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__22;
...
max = function(args, kwargs) {
  ...
  __iterator__23 = __get__(__get__(lst, "__iter__", "no iterator - line 837: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__23;
...
__Iterator___init__ = function(args, kwargs) {
  ...
  self.obj_get = __get__(obj, "get", "missing attribute `get` - line 872: self.obj_get = obj.get  ## cache this for speed");
}
  ...
  if (( pointer ) !== null) {
    ...
    if (__test_if_true__(js_object)) {
      ...
      if (__test_if_true__(ob instanceof Array)) {
        ...
        __iterator__24 = __get__(__get__(ob, "__iter__", "no iterator - line 927: for o in ob:"), "__call__")([], __NULL_OBJECT__);
        var __next__24;
        ...
        while (( __iterator__24.index ) < __iterator__24.length) {
          ...
          if (__test_if_true__(o instanceof Array)) {
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 929: self.__setitem__( o[0], o[1] )"), "__call__")([__get__(o, "__getitem__", "line 929: self.__setitem__( o[0], o[1] )")([0], __NULL_OBJECT__), __get__(o, "__getitem__", "line 929: self.__setitem__( o[0], o[1] )")([1], __NULL_OBJECT__)], __NULL_OBJECT__);
          } else {
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 931: self.__setitem__( o['key'], o['value'] )"), "__call__")([__get__(o, "__getitem__", "line 931: self.__setitem__( o['key'], o['value'] )")(["key"], __NULL_OBJECT__), __get__(o, "__getitem__", "line 931: self.__setitem__( o['key'], o['value'] )")(["value"], __NULL_OBJECT__)], __NULL_OBJECT__);
          }
        }
      } else {
        if (__test_if_true__(isinstance([ob, dict], __NULL_OBJECT__))) {
          var key, __iterator__25;
          __iterator__25 = __get__(__get__(__jsdict_keys(ob), "__iter__", "no iterator - line 933: for key in ob.keys():"), "__call__")([], __NULL_OBJECT__);
          var __next__25;
          __next__25 = __get__(__iterator__25, "next");
          while (( __iterator__25.index ) < __iterator__25.length) {
            key = __next__25();
            value = __get__(ob, "__getitem__", "line 934: value = ob[ key ]")([key], __NULL_OBJECT__);
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 935: self.__setitem__( key, value )"), "__call__")([key, value], __NULL_OBJECT__);
          }
        } else {
...
__dict_jsify = function(args, kwargs) {
  ...
  __iterator__26 = __get__(__get__(keys, "__iter__", "no iterator - line 943: for key in keys:"), "__call__")([], __NULL_OBJECT__);
  var __next__26;
  __next__26 = __get__(__iterator__26, "next");
  while (( __iterator__26.index ) < __iterator__26.length) {
    key = __next__26();
    value = __get__(self["$wrapped"], "__getitem__", "line 944: value = self[...][key]")([key], __NULL_OBJECT__);
    if (( typeof(value) ) == "object") {
      if (__test_if_true__(hasattr([value, "jsify"], __NULL_OBJECT__))) {
        __get__(__get__(self["$wrapped"], "__setitem__"), "__call__")([key, __get__(__get__(value, "jsify", "missing attribute `jsify` - line 947: self[...][key] = value.jsify()"), "__call__")()], {});
      }
    } else {
...
__dict_has_key = function(args, kwargs) {
  ...
  if (__test_if_true__(typeof(key) === 'object' || typeof(key) === 'function')) {
    key = __get__(key, "__uid__", "missing attribute `__uid__` - line 963: key = key.__uid__");
  }
...
__dict_update = function(args, kwargs) {
  ...
  __iterator__27 = __get__(__get__(other, "__iter__", "no iterator - line 971: for key in other:"), "__call__")([], __NULL_OBJECT__);
  var __next__27;
  __next__27 = __get__(__iterator__27, "next");
  while (( __iterator__27.index ) < __iterator__27.length) {
    key = __next__27();
    __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 972: self.__setitem__( key, other[key] )"), "__call__")([key, __get__(other, "__getitem__", "line 972: self.__setitem__( key, other[key] )")([key], __NULL_OBJECT__)], __NULL_OBJECT__);
  }
}
...
__dict_items = function(args, kwargs) {
  ...
  __iterator__28 = __get__(__get__(__jsdict_keys(self), "__iter__", "no iterator - line 976: for key in self.keys():"), "__call__")([], __NULL_OBJECT__);
  var __next__28;
  __next__28 = __get__(__iterator__28, "next");
  while (( __iterator__28.index ) < __iterator__28.length) {
    key = __next__28();
    __get__(__get__(arr, "append", "missing attribute `append` - line 977: arr.append( [key, self[key]] )"), "__call__")([[key, __get__(self, "__getitem__")([key], __NULL_OBJECT__)]], __NULL_OBJECT__);
  }
  return arr;
}
...
__dict_set = function(args, kwargs) {
  ...
  var key = __args__['key'];
  var value = __args__['value'];
  __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 987: self.__setitem__(key, value)"), "__call__")([key, value], __NULL_OBJECT__);
}
...
__array___init__ = function(args, kwargs) {
  ...
  self.itemsize = __get__(__get__(self, "typecodes", "missing attribute `typecodes` - line 1188: self.itemsize = self.typecodes[ typecode ]"), "__getitem__", "line 1188: self.itemsize = self.typecodes[ typecode ]")([typecode], __NULL_OBJECT__);
  ...
  self.buffer = buff;
  __get__(__get__(self, "fromlist", "missing attribute `fromlist` - line 1212: self.fromlist( initializer )"), "__call__")([initializer], __NULL_OBJECT__);
}
...
__array___contains__ = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var value = __args__['value'];
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1220: arr = self.to_array()"), "__call__")();
...
__array___getitem__ = function(args, kwargs) {
  ...
  __left34 = "get";
  __right35 = __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1230: func_name = 'get'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1230: func_name = 'get'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__);
...
__array___setitem__ = function(args, kwargs) {
  ...
  __left38 = "set";
  __right39 = __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1249: func_name = 'set'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1249: func_name = 'set'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__);
...
__array_fromlist = function(args, kwargs) {
  ...
  __left40 = "set";
  __right41 = __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1274: func_name = 'set'+self.typecode_names[ typecode ]"), "__getitem__", "line 1274: func_name = 'set'+self.typecode_names[ typecode ]")([typecode], __NULL_OBJECT__);
  ...
  if (( size ) <= self.bytes) {
    ...
    offset = 0;
    while (( i ) < length) {
      item = __get__(lst, "__getitem__", "line 1279: item = lst[i]")([i], __NULL_OBJECT__);
      if (( typecode ) == "float8") {
        item *= self._norm_set;
      } else {
        if (( typecode ) == "float16") {
...
__array_append = function(args, kwargs) {
  ...
  __right43 = 1;
  __get__(__get__(self, "resize", "missing attribute `resize` - line 1307: self.resize( self.length + 1 )"), "__call__")([((( typeof(__left42) ) == "number") ? (__left42 + __right43) : __add_op(__left42, __right43))], __NULL_OBJECT__);
...
__array_extend = function(args, kwargs) {
  ...
  __iterator__33 = __get__(__get__(lst, "__iter__", "no iterator - line 1311: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__33;
  __next__33 = __get__(__iterator__33, "next");
  while (( __iterator__33.index ) < __iterator__33.length) {
    value = __next__33();
    __get__(__get__(self, "append", "missing attribute `append` - line 1312: self.append( value )"), "__call__")([value], __NULL_OBJECT__);
  }
}
...
__array_to_list = function(args, kwargs) {
  ...
  var self = __args__['self'];
  return __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1324: return self.to_array()"), "__call__")();
}
...
__array_to_ascii = function(args, kwargs) {
  ...
  i = 0;
  length = __get__(arr, "length", "missing attribute `length` - line 1329: i = 0; length = arr.length");
  while (( i ) < length) {
    var num = arr[i];
