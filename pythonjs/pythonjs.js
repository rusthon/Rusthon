...
GLSLJITRuntime.prototype.define_structure = function(ob) {
  var integers,arr,code,arrays,struct_type,member_list,struct_name,t,members,floats;
  struct_name = null;
  ...
  if (! (__contains__(this.struct_types, struct_name))) {
    ...
    console.log(code);
    console.log("------------------------------");
    this.struct_types[struct_name] = __jsdict([["arrays", arrays], ["floats", floats], ["integers", integers], ["code", code]]);
  }
  return struct_name;
}
...
GLSLJITRuntime.prototype.object = function(ob, name) {
  var func,cls;
    var __iter9 = this.object_packagers;
...
__create_class__ = function(class_name, parents, attrs, props) {
  ...
  for (var __idx20=0; __idx20 < __iter20.length; __idx20++) {
    ...
    has_getattr = false;
        var __iter21 = klass.__all_method_names__;
...
issubclass = function(args, kwargs) {
  ...
  bases = C.__bases__;
  i = 0;
  while (( i ) < __get__(bases, "length", "missing attribute `length` - line 621: while i < bases.length:")) {
    if (__test_if_true__(issubclass([((bases instanceof Array) ? bases[i] : __get__(bases, "__getitem__", "line 622: if issubclass( bases[i], B ):")([i], __NULL_OBJECT__)), B], __NULL_OBJECT__))) {
      return true;
    }
    i += 1;
  }
...
sum = function(args, kwargs) {
  ...
  a = 0;
  var b,__iterator__34;
  __iterator__34 = __get__(__get__(arr, "__iter__", "no iterator - line 1111: for b in arr:"), "__call__")([], __NULL_OBJECT__);
  var __next__34;
    ...
    if (__test_if_true__(__is_typed_array(ob))) {
      ...
      if (__test_if_true__(ob instanceof ArrayBuffer)) {
        ...
        if (__test_if_true__(ob instanceof Object)) {
          ...
          return __get__(__get__(ob, "__len__", "missing attribute `__len__` - line 1131: return ob.__len__()"), "__call__")();
        }
      }
    }
  }
...
next = function(args, kwargs) {
  ...
  return __get__(__get__(obj, "next", "missing attribute `next` - line 1135: return obj.next()"), "__call__")();
}
...
map = function(args, kwargs) {
  ...
  arr = [];
  var ob,__iterator__35;
  __iterator__35 = __get__(__get__(objs, "__iter__", "no iterator - line 1140: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__35;
...
filter = function(args, kwargs) {
  ...
  var objs = __args__['objs'];
  arr = [];
  var ob,__iterator__36;
  __iterator__36 = __get__(__get__(objs, "__iter__", "no iterator - line 1148: for ob in objs:"), "__call__")([], __NULL_OBJECT__);
  var __next__36;
...
min = function(args, kwargs) {
  ...
  __iterator__37 = __get__(__get__(lst, "__iter__", "no iterator - line 1157: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__37;
...
max = function(args, kwargs) {
  ...
  __iterator__38 = __get__(__get__(lst, "__iter__", "no iterator - line 1164: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__38;
...
__Iterator___init__ = function(args, kwargs) {
  ...
  self.obj_get = __get__(obj, "get", "missing attribute `get` - line 1199: self.obj_get = obj.get  ## cache this for speed");
}
...
__dict___init__ = function(args, kwargs) {
  ...
  if (( pointer ) !== null) {
    ...
    if (__test_if_true__(js_object)) {
      ob = js_object;
      if (__test_if_true__(ob instanceof Array)) {
        var o,__iterator__39;
        __iterator__39 = __get__(__get__(ob, "__iter__", "no iterator - line 1254: for o in ob:"), "__call__")([], __NULL_OBJECT__);
        var __next__39;
        ...
        if (__test_if_true__(isinstance([ob, dict], __NULL_OBJECT__))) {
          ...
          __iterator__40 = __get__(__get__(__jsdict_keys(ob), "__iter__", "no iterator - line 1260: for key in ob.keys():"), "__call__")([], __NULL_OBJECT__);
          var __next__40;
          __next__40 = __get__(__iterator__40, "next");
          while (( __iterator__40.index ) < __iterator__40.length) {
            key = __next__40();
            value = ((ob instanceof Array) ? ob[key] : __get__(ob, "__getitem__", "line 1261: value = ob[ key ]")([key], __NULL_OBJECT__));
            __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1262: self.__setitem__( key, value )"), "__call__")([key, value], __NULL_OBJECT__);
          }
        } else {
...
__dict_jsify = function(args, kwargs) {
  ...
  __iterator__41 = __get__(__get__(keys, "__iter__", "no iterator - line 1270: for key in keys:"), "__call__")([], __NULL_OBJECT__);
  var __next__41;
  __next__41 = __get__(__iterator__41, "next");
  while (( __iterator__41.index ) < __iterator__41.length) {
    key = __next__41();
    value = __get__(self["$wrapped"], "__getitem__", "line 1271: value = self[...][key]")([key], __NULL_OBJECT__);
    if (( typeof(value) ) == "object") {
      if (__test_if_true__(hasattr([value, "jsify"], __NULL_OBJECT__))) {
        __get__(__get__(self["$wrapped"], "__setitem__"), "__call__")([key, __get__(__get__(value, "jsify", "missing attribute `jsify` - line 1274: self[...][key] = value.jsify()"), "__call__")()], {});
      }
    } else {
...
__dict_has_key = function(args, kwargs) {
  ...
  if (__test_if_true__(typeof(key) === 'object' || typeof(key) === 'function')) {
    key = __get__(key, "__uid__", "missing attribute `__uid__` - line 1290: key = key.__uid__");
  }
...
__dict_update = function(args, kwargs) {
  ...
  __iterator__42 = __get__(__get__(other, "__iter__", "no iterator - line 1298: for key in other:"), "__call__")([], __NULL_OBJECT__);
  var __next__42;
  __next__42 = __get__(__iterator__42, "next");
  while (( __iterator__42.index ) < __iterator__42.length) {
    key = __next__42();
    __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1299: self.__setitem__( key, other[key] )"), "__call__")([key, ((other instanceof Array) ? other[key] : __get__(other, "__getitem__", "line 1299: self.__setitem__( key, other[key] )")([key], __NULL_OBJECT__))], __NULL_OBJECT__);
  }
}
...
__dict_items = function(args, kwargs) {
  ...
  __iterator__43 = __get__(__get__(__jsdict_keys(self), "__iter__", "no iterator - line 1303: for key in self.keys():"), "__call__")([], __NULL_OBJECT__);
  var __next__43;
  __next__43 = __get__(__iterator__43, "next");
  while (( __iterator__43.index ) < __iterator__43.length) {
    key = __next__43();
    __get__(__get__(arr, "append", "missing attribute `append` - line 1304: arr.append( [key, self[key]] )"), "__call__")([[key, __get__(self, "__getitem__")([key], __NULL_OBJECT__)]], __NULL_OBJECT__);
  }
  return arr;
}
...
__dict_set = function(args, kwargs) {
  ...
  var key = __args__['key'];
  var value = __args__['value'];
  __get__(__get__(self, "__setitem__", "missing attribute `__setitem__` - line 1314: self.__setitem__(key, value)"), "__call__")([key, value], __NULL_OBJECT__);
}
...
__array___init__ = function(args, kwargs) {
  ...
  self.itemsize = __get__(__get__(self, "typecodes", "missing attribute `typecodes` - line 1515: self.itemsize = self.typecodes[ typecode ]"), "__getitem__", "line 1515: self.itemsize = self.typecodes[ typecode ]")([typecode], __NULL_OBJECT__);
  ...
  self.buffer = buff;
  __get__(__get__(self, "fromlist", "missing attribute `fromlist` - line 1539: self.fromlist( initializer )"), "__call__")([initializer], __NULL_OBJECT__);
}
...
__array___contains__ = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var value = __args__['value'];
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1547: arr = self.to_array()"), "__call__")();
...
__array___getitem__ = function(args, kwargs) {
  ...
  func_name = ("get" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1557: func_name = 'get'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1557: func_name = 'get'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__));
...
__array___setitem__ = function(args, kwargs) {
  ...
  offset = (step * index);
  dataview = self.dataview;
  func_name = ("set" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1576: func_name = 'set'+self.typecode_names[ self.typecode ]"), "__getitem__", "line 1576: func_name = 'set'+self.typecode_names[ self.typecode ]")([self.typecode], __NULL_OBJECT__));
  func = dataview[func_name].bind(dataview);
  if (( offset ) < self.bytes) {
    if (( self.typecode ) == "float8") {
...
__array_fromlist = function(args, kwargs) {
  ...
  size = (length * step);
  dataview = self.dataview;
  func_name = ("set" + __get__(__get__(self, "typecode_names", "missing attribute `typecode_names` - line 1601: func_name = 'set'+self.typecode_names[ typecode ]"), "__getitem__", "line 1601: func_name = 'set'+self.typecode_names[ typecode ]")([typecode], __NULL_OBJECT__));
  func = dataview[func_name].bind(dataview);
  if (( size ) <= self.bytes) {
    i = 0;
    offset = 0;
    while (( i ) < length) {
      item = ((lst instanceof Array) ? lst[i] : __get__(lst, "__getitem__", "line 1606: item = lst[i]")([i], __NULL_OBJECT__));
      if (( typecode ) == "float8") {
        item *= self._norm_set;
      } else {
        if (( typecode ) == "float16") {
...
__array_append = function(args, kwargs) {
  ...
  var value = __args__['value'];
  length = self.length;
  __get__(__get__(self, "resize", "missing attribute `resize` - line 1634: self.resize( self.length + 1 )"), "__call__")([(self.length + 1)], __NULL_OBJECT__);
...
__array_extend = function(args, kwargs) {
  ...
  var self = __args__['self'];
  var lst = __args__['lst'];
  var value,__iterator__48;
  __iterator__48 = __get__(__get__(lst, "__iter__", "no iterator - line 1638: for value in lst:"), "__call__")([], __NULL_OBJECT__);
  var __next__48;
  __next__48 = __get__(__iterator__48, "next");
  while (( __iterator__48.index ) < __iterator__48.length) {
    value = __next__48();
    __get__(__get__(self, "append", "missing attribute `append` - line 1639: self.append( value )"), "__call__")([value], __NULL_OBJECT__);
  }
}
...
__array_to_list = function(args, kwargs) {
  ...
  var self = __args__['self'];
  return __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1651: return self.to_array()"), "__call__")();
}
...
__array_to_ascii = function(args, kwargs) {
  ...
  var self = __args__['self'];
  string = "";
  arr = __get__(__get__(self, "to_array", "missing attribute `to_array` - line 1655: arr = self.to_array()"), "__call__")();
  i = 0;
  length = __get__(arr, "length", "missing attribute `length` - line 1656: i = 0; length = arr.length");
  while (( i ) < length) {
    var num = arr[i];
...
__get_other_workers_with_shared_arg = function(worker, ob) {
  var a,other,args;
  a = [];
    var __iter34 = threading.workers;
      ...
      if (( event.data.type ) == "call") {
        ...
        if (( event.data.type ) == "append") {
          ...
          a.push(event.data.value);
                    var __iter36 = __get_other_workers_with_shared_arg(worker, a);
          ...
          if (( event.data.type ) == "__setitem__") {
            ...
            if (__test_if_true__(a.__setitem__)) {
              ...
              a[event.data.index] = value;
                        ...
                        var __iter37 = __get_other_workers_with_shared_arg(worker, a);
