...
CPP = {
	'time': {
		#'clock': 'double __clock__() { return std::chrono::duration_cast<std::chrono::nanoseconds>(std::chrono::high_resolution_clock::now().time_since_epoch()).count() / (double)10000.0; }'
		...
		'clock': 'std::chrono::time_point<std::chrono::steady_clock> __clock__() { return std::chrono::steady_clock::now().time_since_epoch(); }'
	},
